...
const Navbar = () => {
    ...
    return (
     <div className="navbar bg-gradient-to-r from-[#0a0400] via-[#321900]   to-[#070000] shadow-sm px-20 py-4">
...
{
  !user && <>
      <button className="px-6 py-3 text-lg font-medium shadow-2xl   rounded-2xl  backdrop-blur-md bg-white/10 border border-white/20 text-white"> <NavLink  to="/login"  >Login</NavLink>   </button>
      <button className="px-4 py-3 text-lg font-medium shadow-2xl   rounded-2xl  backdrop-blur-md bg-white/10 border border-white/20 text-white" > <NavLink to="/register">Registration</NavLink></button>
